# Проект-аттестация "Доска публикаций"
...
4. [Приложения](#apps)
   - [Приложение Publications](#publ_app)
     - [Модели](#publ_models) 
...
1. **publications**: приложение для ведения постов и отзывов.
2. **users**: приложения для создания/редактирования/просмотра и удаления пользователя.

---

## Приложение Publication <a id="publ_app"></a>

Приложение **Publication** создано для создания/редактирования/удаления и ведения постов и отзывов.
